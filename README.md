...
<head>
  ...
  <style>
    ...
    /* Cake base */
    .cake-layer {
      background: linear-gradient(135deg, #f9c7b3, #d67154);
      border-radius: 20px 20px 10px 10px;
      box-shadow: 0 5px 10px #b65a41 inset;
      width: 220px;
      height: 70px;
      margin: 0 auto;
    }
    .cake-layer.top {
      ...
      height: 50px;
      margin-top: -30px;
      background: linear-gradient(135deg, #fcdcbf, #c98157);
    }
    /* Candle */
    .candle {
      position: absolute;
